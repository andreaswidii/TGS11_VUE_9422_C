...
export default { 
    data () { 
        return { 
            drawer: null, 
            items: [ 
                { title: 'User Controller', icon: 'mdi-human-male', link: '/dashboardContents/userController' }, 
                { title: 'Bengkel Controller', icon: 'mdi-human-female', link: '/dashboardContents/bengkelController'},
            ], 
        } 
    },
    methods: {
